...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(675353999205886166)
,p_plug_name=>'&APP_USER.'
,p_region_template_options=>'#DEFAULT#:t-HeroRegion--hideIcon'
,p_plug_template=>wwv_flow_imp.id(50425455681487745607)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(675354341878886166)
,p_plug_name=>'&APP_USER.'
,p_region_template_options=>'#DEFAULT#:t-CardsRegion--styleB'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(50425429558544745597)
...
wwv_flow_imp_page.create_card(
 p_id=>wwv_flow_imp.id(675354851120886168)
,p_region_id=>wwv_flow_imp.id(675354341878886166)
,p_layout_type=>'ROW'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(675355371945886172)
...
,p_list_id=>wwv_flow_imp.id(675352928699886157)
