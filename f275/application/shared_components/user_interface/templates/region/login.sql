...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(50425883818755745618)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600207492566881914)
,p_plug_template_id=>wwv_flow_imp.id(50425883818755745618)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600208046036881914)
,p_plug_template_id=>wwv_flow_imp.id(50425883818755745618)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600208558507881915)
,p_plug_template_id=>wwv_flow_imp.id(50425883818755745618)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600209076038881915)
,p_plug_template_id=>wwv_flow_imp.id(50425883818755745618)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600209553702881915)
,p_plug_template_id=>wwv_flow_imp.id(50425883818755745618)
,p_name=>'Sub Regions'
