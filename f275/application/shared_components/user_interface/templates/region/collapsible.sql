...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(50425441335216745602)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600100710613881852)
,p_plug_template_id=>wwv_flow_imp.id(50425441335216745602)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600101198765881855)
,p_plug_template_id=>wwv_flow_imp.id(50425441335216745602)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600101766337881855)
,p_plug_template_id=>wwv_flow_imp.id(50425441335216745602)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600102266636881855)
,p_plug_template_id=>wwv_flow_imp.id(50425441335216745602)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600102726981881855)
,p_plug_template_id=>wwv_flow_imp.id(50425441335216745602)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600103215167881856)
,p_plug_template_id=>wwv_flow_imp.id(50425441335216745602)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600103752767881856)
,p_plug_template_id=>wwv_flow_imp.id(50425441335216745602)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600104217830881856)
,p_plug_template_id=>wwv_flow_imp.id(50425441335216745602)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600104710403881856)
,p_plug_template_id=>wwv_flow_imp.id(50425441335216745602)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600105238112881857)
,p_plug_template_id=>wwv_flow_imp.id(50425441335216745602)
,p_name=>'Sub Regions'
