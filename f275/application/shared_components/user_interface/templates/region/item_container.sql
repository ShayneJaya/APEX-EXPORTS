...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(50425881349929745617)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600200725186881910)
,p_plug_template_id=>wwv_flow_imp.id(50425881349929745617)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600201274128881910)
,p_plug_template_id=>wwv_flow_imp.id(50425881349929745617)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600201708677881910)
,p_plug_template_id=>wwv_flow_imp.id(50425881349929745617)
,p_name=>'Button Start'
