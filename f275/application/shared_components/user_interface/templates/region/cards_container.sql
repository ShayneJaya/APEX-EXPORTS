...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(50425429558544745597)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600068563852881831)
,p_plug_template_id=>wwv_flow_imp.id(50425429558544745597)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600069062133881831)
,p_plug_template_id=>wwv_flow_imp.id(50425429558544745597)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600069556611881831)
,p_plug_template_id=>wwv_flow_imp.id(50425429558544745597)
,p_name=>'Sub Regions'
