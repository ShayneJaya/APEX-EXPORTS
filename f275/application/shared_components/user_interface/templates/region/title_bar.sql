...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(50425901409080745626)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600257219296881940)
,p_plug_template_id=>wwv_flow_imp.id(50425901409080745626)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600257747586881941)
,p_plug_template_id=>wwv_flow_imp.id(50425901409080745626)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600258251584881941)
,p_plug_template_id=>wwv_flow_imp.id(50425901409080745626)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600258692771881941)
,p_plug_template_id=>wwv_flow_imp.id(50425901409080745626)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600259227382881941)
,p_plug_template_id=>wwv_flow_imp.id(50425901409080745626)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600259700950881941)
,p_plug_template_id=>wwv_flow_imp.id(50425901409080745626)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600260259235881942)
,p_plug_template_id=>wwv_flow_imp.id(50425901409080745626)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600260711063881942)
,p_plug_template_id=>wwv_flow_imp.id(50425901409080745626)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600261248076881942)
,p_plug_template_id=>wwv_flow_imp.id(50425901409080745626)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600261770476881942)
,p_plug_template_id=>wwv_flow_imp.id(50425901409080745626)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600262196203881942)
,p_plug_template_id=>wwv_flow_imp.id(50425901409080745626)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600262711021881942)
,p_plug_template_id=>wwv_flow_imp.id(50425901409080745626)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600263239187881943)
,p_plug_template_id=>wwv_flow_imp.id(50425901409080745626)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
