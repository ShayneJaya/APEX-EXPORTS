...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(50425451123550745605)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600125822225881869)
,p_plug_template_id=>wwv_flow_imp.id(50425451123550745605)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600126329099881869)
,p_plug_template_id=>wwv_flow_imp.id(50425451123550745605)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600126878304881869)
,p_plug_template_id=>wwv_flow_imp.id(50425451123550745605)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600127359271881869)
,p_plug_template_id=>wwv_flow_imp.id(50425451123550745605)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600127788937881870)
,p_plug_template_id=>wwv_flow_imp.id(50425451123550745605)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600128297942881870)
,p_plug_template_id=>wwv_flow_imp.id(50425451123550745605)
,p_name=>'Sub Regions'
