...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(50425455681487745607)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600136482688881875)
,p_plug_template_id=>wwv_flow_imp.id(50425455681487745607)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600137030683881875)
,p_plug_template_id=>wwv_flow_imp.id(50425455681487745607)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600137493389881875)
,p_plug_template_id=>wwv_flow_imp.id(50425455681487745607)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600138080418881875)
,p_plug_template_id=>wwv_flow_imp.id(50425455681487745607)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600138524140881876)
,p_plug_template_id=>wwv_flow_imp.id(50425455681487745607)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
