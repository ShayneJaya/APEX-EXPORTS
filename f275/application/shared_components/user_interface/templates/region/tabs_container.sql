...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(50425898778053745624)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600247477867881935)
,p_plug_template_id=>wwv_flow_imp.id(50425898778053745624)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600247975448881935)
,p_plug_template_id=>wwv_flow_imp.id(50425898778053745624)
,p_name=>'Tabs'
