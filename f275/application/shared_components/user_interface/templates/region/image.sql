...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(50425459236624745609)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600144046982881879)
,p_plug_template_id=>wwv_flow_imp.id(50425459236624745609)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600144580024881879)
,p_plug_template_id=>wwv_flow_imp.id(50425459236624745609)
,p_name=>'Sub Regions'
