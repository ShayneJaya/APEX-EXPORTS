...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(50425886342972745619)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600213307377881917)
,p_plug_template_id=>wwv_flow_imp.id(50425886342972745619)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600213813972881917)
,p_plug_template_id=>wwv_flow_imp.id(50425886342972745619)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600214376869881917)
,p_plug_template_id=>wwv_flow_imp.id(50425886342972745619)
,p_name=>'Sub Regions'
