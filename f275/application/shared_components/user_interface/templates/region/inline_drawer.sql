...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(50425869187280745613)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600171042798881894)
,p_plug_template_id=>wwv_flow_imp.id(50425869187280745613)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600171568104881895)
,p_plug_template_id=>wwv_flow_imp.id(50425869187280745613)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600172052395881895)
,p_plug_template_id=>wwv_flow_imp.id(50425869187280745613)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600172508619881895)
,p_plug_template_id=>wwv_flow_imp.id(50425869187280745613)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600173037839881895)
,p_plug_template_id=>wwv_flow_imp.id(50425869187280745613)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600173515608881895)
,p_plug_template_id=>wwv_flow_imp.id(50425869187280745613)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600174067553881896)
,p_plug_template_id=>wwv_flow_imp.id(50425869187280745613)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600174494669881896)
,p_plug_template_id=>wwv_flow_imp.id(50425869187280745613)
,p_name=>'Sub Regions'
