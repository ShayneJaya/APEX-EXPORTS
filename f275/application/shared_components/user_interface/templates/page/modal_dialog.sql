...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(50425407162971745587)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600009781738881794)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600010339982881794)
,p_page_template_id=>wwv_flow_imp.id(50425407162971745587)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600010798424881794)
,p_page_template_id=>wwv_flow_imp.id(50425407162971745587)
