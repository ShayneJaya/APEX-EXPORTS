...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(50425397079074745584)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(599982972930881779)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(599983451315881780)
,p_page_template_id=>wwv_flow_imp.id(50425397079074745584)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(599983965626881780)
,p_page_template_id=>wwv_flow_imp.id(50425397079074745584)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(599984452936881780)
,p_page_template_id=>wwv_flow_imp.id(50425397079074745584)
,p_name=>'Body Footer'
