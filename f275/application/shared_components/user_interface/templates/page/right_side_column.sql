...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(50425408651030745588)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600016592918881797)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600017113564881797)
,p_page_template_id=>wwv_flow_imp.id(50425408651030745588)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600017639003881798)
,p_page_template_id=>wwv_flow_imp.id(50425408651030745588)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600018097980881798)
,p_page_template_id=>wwv_flow_imp.id(50425408651030745588)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600018648039881798)
,p_page_template_id=>wwv_flow_imp.id(50425408651030745588)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600019165007881798)
,p_page_template_id=>wwv_flow_imp.id(50425408651030745588)
,p_name=>'Right Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600019660956881798)
,p_page_template_id=>wwv_flow_imp.id(50425408651030745588)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600020146808881799)
,p_page_template_id=>wwv_flow_imp.id(50425408651030745588)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600020610946881799)
,p_page_template_id=>wwv_flow_imp.id(50425408651030745588)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600021113127881799)
,p_page_template_id=>wwv_flow_imp.id(50425408651030745588)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600021653785881799)
,p_page_template_id=>wwv_flow_imp.id(50425408651030745588)
