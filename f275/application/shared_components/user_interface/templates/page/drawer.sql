...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(50425386514200745579)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(599953739211881749)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(599954268900881750)
,p_page_template_id=>wwv_flow_imp.id(50425386514200745579)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(599954778966881750)
,p_page_template_id=>wwv_flow_imp.id(50425386514200745579)
