prompt --application/shared_components/user_interface/templates/page/sticky_footer
begin
--   Manifest
--     TEMPLATE: STICKY_FOOTER
--   Manifest End
...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(672769294340086892)
,p_theme_id=>42
,p_name=>'Sticky Footer'
,p_internal_name=>'STICKY_FOOTER'
,p_is_popup=>false
...
'</body>',
'    <footer class="sticky-footer" id="sticky-footer" role="contentinfo">',
'        <!-- <div class="t-Footer-body"> -->',
'          <div>#REGION_POSITION_05#</div>',
'        <!-- </div> -->',
'    </footer>',
'</html>',
''))
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(672769691723086906)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(672770195283086907)
,p_page_template_id=>wwv_flow_imp.id(672769294340086892)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(672770664425086907)
,p_page_template_id=>wwv_flow_imp.id(672769294340086892)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(672771175949086908)
,p_page_template_id=>wwv_flow_imp.id(672769294340086892)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(672771643286086908)
,p_page_template_id=>wwv_flow_imp.id(672769294340086892)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(672772188980086908)
,p_page_template_id=>wwv_flow_imp.id(672769294340086892)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(672772702462086909)
,p_page_template_id=>wwv_flow_imp.id(672769294340086892)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(672773129256086909)
,p_page_template_id=>wwv_flow_imp.id(672769294340086892)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(672773607554086910)
,p_page_template_id=>wwv_flow_imp.id(672769294340086892)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(672774128565086910)
,p_page_template_id=>wwv_flow_imp.id(672769294340086892)
