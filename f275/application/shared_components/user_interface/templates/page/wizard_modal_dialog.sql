...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(50425415688717745591)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600033383448881806)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600033947260881806)
,p_page_template_id=>wwv_flow_imp.id(50425415688717745591)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(600034441423881806)
,p_page_template_id=>wwv_flow_imp.id(50425415688717745591)
