...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(50425389390342745581)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(599963817630881761)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(599964291794881761)
,p_page_template_id=>wwv_flow_imp.id(50425389390342745581)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(599964868435881762)
,p_page_template_id=>wwv_flow_imp.id(50425389390342745581)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(599965351622881762)
,p_page_template_id=>wwv_flow_imp.id(50425389390342745581)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(599965859476881762)
,p_page_template_id=>wwv_flow_imp.id(50425389390342745581)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(599966311212881762)
,p_page_template_id=>wwv_flow_imp.id(50425389390342745581)
,p_name=>'Left Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(599966831703881762)
,p_page_template_id=>wwv_flow_imp.id(50425389390342745581)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(599967381049881763)
,p_page_template_id=>wwv_flow_imp.id(50425389390342745581)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(599967819429881763)
,p_page_template_id=>wwv_flow_imp.id(50425389390342745581)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(599968373604881763)
,p_page_template_id=>wwv_flow_imp.id(50425389390342745581)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(599968872487881768)
,p_page_template_id=>wwv_flow_imp.id(50425389390342745581)
