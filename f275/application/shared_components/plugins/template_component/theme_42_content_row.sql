...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(50425991768331745669)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2527678043426953827)
,p_plugin_id=>wwv_flow_imp.id(50425991768331745669)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2527677488414953826)
,p_plugin_id=>wwv_flow_imp.id(50425991768331745669)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2270785424684680313)
,p_plugin_id=>wwv_flow_imp.id(50425991768331745669)
,p_title=>'Appearance'
,p_display_sequence=>30
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600441692447882135)
,p_plugin_id=>wwv_flow_imp.id(50425991768331745669)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600442277413882135)
,p_plugin_id=>wwv_flow_imp.id(50425991768331745669)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600442721968882136)
,p_plugin_id=>wwv_flow_imp.id(50425991768331745669)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600443258884882136)
,p_plugin_id=>wwv_flow_imp.id(50425991768331745669)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600443754367882137)
,p_plugin_id=>wwv_flow_imp.id(50425991768331745669)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600444281210882137)
,p_plugin_id=>wwv_flow_imp.id(50425991768331745669)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600444716838882138)
,p_plugin_id=>wwv_flow_imp.id(50425991768331745669)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(600443754367882137)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(2527678043426953827)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600445256509882138)
,p_plugin_attribute_id=>wwv_flow_imp.id(600444716838882138)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600445827073882139)
,p_plugin_attribute_id=>wwv_flow_imp.id(600444716838882138)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600446393611882139)
,p_plugin_attribute_id=>wwv_flow_imp.id(600444716838882138)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600447293694882140)
,p_plugin_id=>wwv_flow_imp.id(50425991768331745669)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(600444716838882138)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600447862804882140)
,p_plugin_id=>wwv_flow_imp.id(50425991768331745669)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600448374872882141)
,p_plugin_id=>wwv_flow_imp.id(50425991768331745669)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600448863756882141)
,p_plugin_id=>wwv_flow_imp.id(50425991768331745669)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600449357750882142)
,p_plugin_id=>wwv_flow_imp.id(50425991768331745669)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600449835385882142)
,p_plugin_attribute_id=>wwv_flow_imp.id(600449357750882142)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600450476330882143)
,p_plugin_attribute_id=>wwv_flow_imp.id(600449357750882142)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600451016890882143)
,p_plugin_attribute_id=>wwv_flow_imp.id(600449357750882142)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600451640063882144)
,p_plugin_attribute_id=>wwv_flow_imp.id(600449357750882142)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600452242586882144)
,p_plugin_id=>wwv_flow_imp.id(50425991768331745669)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(600444281210882137)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(2527677488414953826)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600452696618882144)
,p_plugin_id=>wwv_flow_imp.id(50425991768331745669)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600453251943882145)
,p_plugin_id=>wwv_flow_imp.id(50425991768331745669)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600453705295882145)
,p_plugin_id=>wwv_flow_imp.id(50425991768331745669)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600454223046882145)
,p_plugin_id=>wwv_flow_imp.id(50425991768331745669)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600454781367882146)
,p_plugin_id=>wwv_flow_imp.id(50425991768331745669)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600455241312882146)
,p_plugin_attribute_id=>wwv_flow_imp.id(600454781367882146)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600455843811882147)
,p_plugin_attribute_id=>wwv_flow_imp.id(600454781367882146)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600456465737882147)
,p_plugin_id=>wwv_flow_imp.id(50425991768331745669)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600456883766882148)
,p_plugin_attribute_id=>wwv_flow_imp.id(600456465737882147)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600457546678882149)
,p_plugin_attribute_id=>wwv_flow_imp.id(600456465737882147)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600458144590882149)
,p_plugin_attribute_id=>wwv_flow_imp.id(600456465737882147)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600458692051882150)
,p_plugin_attribute_id=>wwv_flow_imp.id(600456465737882147)
,p_display_sequence=>40
,p_display_value=>'No Shape'
,p_return_value=>'t-Avatar--noShape'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600459354149882150)
,p_plugin_id=>wwv_flow_imp.id(50425991768331745669)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600459816530882151)
,p_plugin_attribute_id=>wwv_flow_imp.id(600459354149882150)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600460411035882151)
,p_plugin_attribute_id=>wwv_flow_imp.id(600459354149882150)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600461049312882151)
,p_plugin_attribute_id=>wwv_flow_imp.id(600459354149882150)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600461599867882152)
,p_plugin_attribute_id=>wwv_flow_imp.id(600459354149882150)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600462218262882152)
,p_plugin_attribute_id=>wwv_flow_imp.id(600459354149882150)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600462833755882153)
,p_plugin_attribute_id=>wwv_flow_imp.id(600459354149882150)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600463402146882153)
,p_plugin_attribute_id=>wwv_flow_imp.id(600459354149882150)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600463985932882154)
,p_plugin_id=>wwv_flow_imp.id(50425991768331745669)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600464498593882154)
,p_plugin_attribute_id=>wwv_flow_imp.id(600463985932882154)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600465178094882155)
,p_plugin_attribute_id=>wwv_flow_imp.id(600463985932882154)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600465687923882155)
,p_plugin_attribute_id=>wwv_flow_imp.id(600463985932882154)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600466289618882156)
,p_plugin_id=>wwv_flow_imp.id(50425991768331745669)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600466873887882156)
,p_plugin_attribute_id=>wwv_flow_imp.id(600466289618882156)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-ContentRow-badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600467465588882157)
,p_plugin_attribute_id=>wwv_flow_imp.id(600466289618882156)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600468049404882157)
,p_plugin_attribute_id=>wwv_flow_imp.id(600466289618882156)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600468679475882158)
,p_plugin_attribute_id=>wwv_flow_imp.id(600466289618882156)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600469273369882158)
,p_plugin_id=>wwv_flow_imp.id(50425991768331745669)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600469732176882159)
,p_plugin_attribute_id=>wwv_flow_imp.id(600469273369882158)
,p_display_sequence=>10
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600470358033882159)
,p_plugin_id=>wwv_flow_imp.id(50425991768331745669)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600470795942882160)
,p_plugin_attribute_id=>wwv_flow_imp.id(600470358033882159)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600471456840882160)
,p_plugin_attribute_id=>wwv_flow_imp.id(600470358033882159)
,p_display_sequence=>20
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600472044581882160)
,p_plugin_id=>wwv_flow_imp.id(50425991768331745669)
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_attribute_group_id=>wwv_flow_imp.id(2270785424684680313)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600472507062882161)
,p_plugin_id=>wwv_flow_imp.id(50425991768331745669)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600472991516882161)
,p_plugin_attribute_id=>wwv_flow_imp.id(600472507062882161)
,p_display_sequence=>10
,p_display_value=>'Compact'
,p_return_value=>'t-ContentRow--styleCompact'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600473644292882162)
,p_plugin_id=>wwv_flow_imp.id(50425991768331745669)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600474147569882162)
,p_plugin_id=>wwv_flow_imp.id(50425991768331745669)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(52234443551509638978)
,p_plugin_id=>wwv_flow_imp.id(50425991768331745669)
,p_name=>'Button'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(52234444811029643126)
,p_plugin_id=>wwv_flow_imp.id(50425991768331745669)
,p_name=>'Menu'
,p_type=>'MENU'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2111940418747017011)
,p_plugin_id=>wwv_flow_imp.id(50425991768331745669)
,p_name=>'Badge Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(52220849922835232245)
,p_plugin_id=>wwv_flow_imp.id(50425991768331745669)
,p_name=>'Title Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(52221529223565315349)
,p_plugin_id=>wwv_flow_imp.id(50425991768331745669)
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(52234441616442593992)
,p_plugin_id=>wwv_flow_imp.id(50425991768331745669)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(52234442949832607849)
,p_plugin_id=>wwv_flow_imp.id(50425991768331745669)
