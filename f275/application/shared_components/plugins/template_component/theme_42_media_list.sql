...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(50426014201979745679)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2400503459003765831)
,p_plugin_id=>wwv_flow_imp.id(50426014201979745679)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2400502903991765830)
,p_plugin_id=>wwv_flow_imp.id(50426014201979745679)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600486169408882184)
,p_plugin_id=>wwv_flow_imp.id(50426014201979745679)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600486668611882184)
,p_plugin_id=>wwv_flow_imp.id(50426014201979745679)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600487109265882185)
,p_plugin_id=>wwv_flow_imp.id(50426014201979745679)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600487635991882185)
,p_plugin_id=>wwv_flow_imp.id(50426014201979745679)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600488178914882186)
,p_plugin_id=>wwv_flow_imp.id(50426014201979745679)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(600487109265882185)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(2400503459003765831)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600488591365882187)
,p_plugin_attribute_id=>wwv_flow_imp.id(600488178914882186)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600489234214882187)
,p_plugin_attribute_id=>wwv_flow_imp.id(600488178914882186)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600489801275882188)
,p_plugin_attribute_id=>wwv_flow_imp.id(600488178914882186)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600490470578882188)
,p_plugin_id=>wwv_flow_imp.id(50426014201979745679)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(600488178914882186)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600490940153882188)
,p_plugin_id=>wwv_flow_imp.id(50426014201979745679)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600491440170882189)
,p_plugin_id=>wwv_flow_imp.id(50426014201979745679)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600491900639882189)
,p_plugin_id=>wwv_flow_imp.id(50426014201979745679)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600492452677882191)
,p_plugin_id=>wwv_flow_imp.id(50426014201979745679)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600492968012882192)
,p_plugin_attribute_id=>wwv_flow_imp.id(600492452677882191)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600493483922882192)
,p_plugin_attribute_id=>wwv_flow_imp.id(600492452677882191)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600494149081882193)
,p_plugin_attribute_id=>wwv_flow_imp.id(600492452677882191)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600494763348882193)
,p_plugin_attribute_id=>wwv_flow_imp.id(600492452677882191)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600495320854882194)
,p_plugin_id=>wwv_flow_imp.id(50426014201979745679)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(600487635991882185)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(2400502903991765830)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600495877039882194)
,p_plugin_id=>wwv_flow_imp.id(50426014201979745679)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600496303605882194)
,p_plugin_id=>wwv_flow_imp.id(50426014201979745679)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600496821536882195)
,p_plugin_id=>wwv_flow_imp.id(50426014201979745679)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600497316496882195)
,p_plugin_id=>wwv_flow_imp.id(50426014201979745679)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600497807428882196)
,p_plugin_id=>wwv_flow_imp.id(50426014201979745679)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600498310254882196)
,p_plugin_attribute_id=>wwv_flow_imp.id(600497807428882196)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600498944503882196)
,p_plugin_attribute_id=>wwv_flow_imp.id(600497807428882196)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600499482313882197)
,p_plugin_id=>wwv_flow_imp.id(50426014201979745679)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600500017247882197)
,p_plugin_attribute_id=>wwv_flow_imp.id(600499482313882197)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600500600615882198)
,p_plugin_attribute_id=>wwv_flow_imp.id(600499482313882197)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600501190580882198)
,p_plugin_attribute_id=>wwv_flow_imp.id(600499482313882197)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600501804211882198)
,p_plugin_id=>wwv_flow_imp.id(50426014201979745679)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600502346033882199)
,p_plugin_attribute_id=>wwv_flow_imp.id(600501804211882198)
,p_display_sequence=>10
,p_display_value=>'2 Column Grid'
,p_return_value=>'t-MediaList--cols t-MediaList--2cols'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600502936696882200)
,p_plugin_attribute_id=>wwv_flow_imp.id(600501804211882198)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600503581276882201)
,p_plugin_attribute_id=>wwv_flow_imp.id(600501804211882198)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600504103749882201)
,p_plugin_attribute_id=>wwv_flow_imp.id(600501804211882198)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600504779564882202)
,p_plugin_attribute_id=>wwv_flow_imp.id(600501804211882198)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600505364265882202)
,p_plugin_id=>wwv_flow_imp.id(50426014201979745679)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600505872978882203)
,p_plugin_attribute_id=>wwv_flow_imp.id(600505364265882202)
,p_display_sequence=>10
,p_display_value=>'Large'
,p_return_value=>'t-MediaList--large force-fa-lg'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600506418550882203)
,p_plugin_id=>wwv_flow_imp.id(50426014201979745679)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(52226235644701775957)
,p_plugin_id=>wwv_flow_imp.id(50426014201979745679)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
