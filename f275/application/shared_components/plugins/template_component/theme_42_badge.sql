...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(50425973218247745659)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600409467286882091)
,p_plugin_id=>wwv_flow_imp.id(50425973218247745659)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600409910305882091)
,p_plugin_id=>wwv_flow_imp.id(50425973218247745659)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600410382387882092)
,p_plugin_id=>wwv_flow_imp.id(50425973218247745659)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600410969874882092)
,p_plugin_id=>wwv_flow_imp.id(50425973218247745659)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600411409880882092)
,p_plugin_id=>wwv_flow_imp.id(50425973218247745659)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600411898399882093)
,p_plugin_id=>wwv_flow_imp.id(50425973218247745659)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600412454645882093)
,p_plugin_attribute_id=>wwv_flow_imp.id(600411898399882093)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600413078152882094)
,p_plugin_attribute_id=>wwv_flow_imp.id(600411898399882093)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600413620934882094)
,p_plugin_id=>wwv_flow_imp.id(50425973218247745659)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600414112042882094)
,p_plugin_attribute_id=>wwv_flow_imp.id(600413620934882094)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600414729265882095)
,p_plugin_attribute_id=>wwv_flow_imp.id(600413620934882094)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600415330337882095)
,p_plugin_attribute_id=>wwv_flow_imp.id(600413620934882094)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600415897989882096)
,p_plugin_id=>wwv_flow_imp.id(50425973218247745659)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600416410765882096)
,p_plugin_attribute_id=>wwv_flow_imp.id(600415897989882096)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600417075082882096)
,p_plugin_attribute_id=>wwv_flow_imp.id(600415897989882096)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600417587829882097)
,p_plugin_attribute_id=>wwv_flow_imp.id(600415897989882096)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2111891358963984279)
,p_plugin_id=>wwv_flow_imp.id(50425973218247745659)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
