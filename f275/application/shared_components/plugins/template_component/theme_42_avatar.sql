...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(50425964364872745654)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600395040092882054)
,p_plugin_id=>wwv_flow_imp.id(50425964364872745654)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600395554127882057)
,p_plugin_attribute_id=>wwv_flow_imp.id(600395040092882054)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600396159248882061)
,p_plugin_attribute_id=>wwv_flow_imp.id(600395040092882054)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600396763207882062)
,p_plugin_attribute_id=>wwv_flow_imp.id(600395040092882054)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600397378831882064)
,p_plugin_id=>wwv_flow_imp.id(50425964364872745654)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(600395040092882054)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600397791082882065)
,p_plugin_id=>wwv_flow_imp.id(50425964364872745654)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600398298198882067)
,p_plugin_id=>wwv_flow_imp.id(50425964364872745654)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600398860851882067)
,p_plugin_id=>wwv_flow_imp.id(50425964364872745654)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600399339214882067)
,p_plugin_id=>wwv_flow_imp.id(50425964364872745654)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600399798461882068)
,p_plugin_attribute_id=>wwv_flow_imp.id(600399339214882067)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600400392003882069)
,p_plugin_attribute_id=>wwv_flow_imp.id(600399339214882067)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600401035481882070)
,p_plugin_attribute_id=>wwv_flow_imp.id(600399339214882067)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600401609000882070)
,p_plugin_attribute_id=>wwv_flow_imp.id(600399339214882067)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600402272647882071)
,p_plugin_id=>wwv_flow_imp.id(50425964364872745654)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600402778467882071)
,p_plugin_attribute_id=>wwv_flow_imp.id(600402272647882071)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600403367439882071)
,p_plugin_attribute_id=>wwv_flow_imp.id(600402272647882071)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600403979794882072)
,p_plugin_attribute_id=>wwv_flow_imp.id(600402272647882071)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600404567470882072)
,p_plugin_attribute_id=>wwv_flow_imp.id(600402272647882071)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600405142626882072)
,p_plugin_attribute_id=>wwv_flow_imp.id(600402272647882071)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600405742425882074)
,p_plugin_attribute_id=>wwv_flow_imp.id(600402272647882071)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600406348064882075)
,p_plugin_attribute_id=>wwv_flow_imp.id(600402272647882071)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600406935771882075)
,p_plugin_id=>wwv_flow_imp.id(50425964364872745654)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(52226015152671859406)
,p_plugin_id=>wwv_flow_imp.id(50425964364872745654)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
