...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(50425981789320745663)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2400308522595913824)
,p_plugin_id=>wwv_flow_imp.id(50425981789320745663)
,p_title=>'Avatar'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600423701325882111)
,p_plugin_id=>wwv_flow_imp.id(50425981789320745663)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600424184943882112)
,p_plugin_id=>wwv_flow_imp.id(50425981789320745663)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600424746531882112)
,p_plugin_id=>wwv_flow_imp.id(50425981789320745663)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600425208405882112)
,p_plugin_id=>wwv_flow_imp.id(50425981789320745663)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600425738656882113)
,p_plugin_id=>wwv_flow_imp.id(50425981789320745663)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(600432894733882118)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(2400308522595913824)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600426216609882113)
,p_plugin_attribute_id=>wwv_flow_imp.id(600425738656882113)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600426830591882113)
,p_plugin_attribute_id=>wwv_flow_imp.id(600425738656882113)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600427440102882114)
,p_plugin_attribute_id=>wwv_flow_imp.id(600425738656882113)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600428000632882114)
,p_plugin_id=>wwv_flow_imp.id(50425981789320745663)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(600425738656882113)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600428486323882115)
,p_plugin_id=>wwv_flow_imp.id(50425981789320745663)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600428994572882115)
,p_plugin_id=>wwv_flow_imp.id(50425981789320745663)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600429521372882115)
,p_plugin_id=>wwv_flow_imp.id(50425981789320745663)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600430001857882116)
,p_plugin_id=>wwv_flow_imp.id(50425981789320745663)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600430524883882116)
,p_plugin_attribute_id=>wwv_flow_imp.id(600430001857882116)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600431086151882116)
,p_plugin_attribute_id=>wwv_flow_imp.id(600430001857882116)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600431704965882117)
,p_plugin_attribute_id=>wwv_flow_imp.id(600430001857882116)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600432374342882117)
,p_plugin_attribute_id=>wwv_flow_imp.id(600430001857882116)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600432894733882118)
,p_plugin_id=>wwv_flow_imp.id(50425981789320745663)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600433392775882118)
,p_plugin_id=>wwv_flow_imp.id(50425981789320745663)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600433970476882119)
,p_plugin_id=>wwv_flow_imp.id(50425981789320745663)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600434457830882119)
,p_plugin_attribute_id=>wwv_flow_imp.id(600433970476882119)
,p_display_sequence=>10
,p_display_value=>'Basic'
,p_return_value=>'t-Comments--basic'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(600435019617882120)
,p_plugin_attribute_id=>wwv_flow_imp.id(600433970476882119)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600435653786882120)
,p_plugin_id=>wwv_flow_imp.id(50425981789320745663)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(52225999945324878882)
,p_plugin_id=>wwv_flow_imp.id(50425981789320745663)
,p_name=>'Link'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(52225999353819871425)
,p_plugin_id=>wwv_flow_imp.id(50425981789320745663)
,p_name=>'Actions'
,p_static_id=>'ACTIONS'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(52226054977489853304)
,p_plugin_id=>wwv_flow_imp.id(50425981789320745663)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(52226207195202724075)
,p_plugin_id=>wwv_flow_imp.id(50425981789320745663)
