...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(50425979137942745662)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600418995472882101)
,p_plugin_id=>wwv_flow_imp.id(50425979137942745662)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600419493205882101)
,p_plugin_id=>wwv_flow_imp.id(50425979137942745662)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600420070085882102)
,p_plugin_id=>wwv_flow_imp.id(50425979137942745662)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600420539469882102)
,p_plugin_id=>wwv_flow_imp.id(50425979137942745662)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600421017632882102)
,p_plugin_id=>wwv_flow_imp.id(50425979137942745662)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600421531854882103)
,p_plugin_id=>wwv_flow_imp.id(50425979137942745662)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600422003507882103)
,p_plugin_id=>wwv_flow_imp.id(50425979137942745662)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(600422526906882103)
,p_plugin_id=>wwv_flow_imp.id(50425979137942745662)
,p_attribute_scope=>'COMPONENT'
